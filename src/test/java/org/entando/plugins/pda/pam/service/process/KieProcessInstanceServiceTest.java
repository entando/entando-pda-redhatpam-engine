...
public class KieProcessInstanceServiceTest {
    ...
    public void shouldListProcessInstances() {
        ...
        when(queryServicesClient
                .findProcessInstancesByProcessIdAndInitiator(eq(processDefinitionId), eq(TEST_USER), any(), anyInt(),
        ...
        verify(queryServicesClient)
                .findProcessInstancesByProcessIdAndInitiator(processDefinitionId, TEST_USER,
